...
use PayerIT\Api\Amount;
use PayerIT\Api\Payer;
use PayerIT\Api\Payment;
use PayerIT\Api\RedirectUrls;
use PayerIT\Api\Transaction;

//Payer Object
$payer = new Payer();
$payer->setPaymentMethod('payerit'); //preferably, your system name, example - PayerIT
...
$urls->setSuccessUrl('http://your-merchant-domain.com/example-success.php') //success url - the merchant domain page, to redirect after successful payment, see sample example-success.php file in sdk root
